...
public:
    ...
    {
        __m256i c0_, c1_, c2_;
        Goldilocks::add_avx(c0_, a_[0], b_[0]);
        Goldilocks::add_avx(c1_, a_[1], b_[1]);
        Goldilocks::add_avx(c2_, a_[2], b_[2]);
    ...
    {
        __m256i c0_, c1_, c2_;
        Goldilocks::sub_avx(c0_, a_[0], b_[0]);
        Goldilocks::sub_avx(c1_, a_[1], b_[1]);
        Goldilocks::sub_avx(c2_, a_[2], b_[2]);
